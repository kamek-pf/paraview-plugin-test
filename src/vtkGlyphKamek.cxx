...
vtkStandardNewMacro(vtkGlyphKamek);
vtkCxxSetObjectMacro(vtkGlyphKamek, SourceTransform, vtkTransform);
...
//----------------------------------------------------------------------------
unsigned long vtkGlyphKamek::GetMTime()
{
...
void vtkGlyphKamek::SetSourceConnection(int id, vtkAlgorithmOutput* algOutput)
{
  if (id < 0)
    {
...
//----------------------------------------------------------------------------
// Specify a source object at a specified table location.
void vtkGlyphKamek::SetSource(int id, vtkPolyData *pd)
{
  if (id < 0)
    {
    vtkErrorMacro("Bad index " << id << " for source.");
...
vtkPolyData *vtkGlyphKamek::GetSource(int id)
{
...
//----------------------------------------------------------------------------
void vtkGlyphKamek::PrintSelf(ostream& os, vtkIndent indent)
{
...
int vtkGlyphKamek::RequestUpdateExtent(
  vtkInformation *vtkNotUsed(request),
  vtkInformationVector **inputVector,
  vtkInformationVector *outputVector)
{
...
//----------------------------------------------------------------------------
vtkPolyData* vtkGlyphKamek::GetSource(int idx, vtkInformationVector *sourceInfo)
{
...
//----------------------------------------------------------------------------
int vtkGlyphKamek::FillInputPortInformation(int port, vtkInformation *info)
{
  if (port == 0)
    {
