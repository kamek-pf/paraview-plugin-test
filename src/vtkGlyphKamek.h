...
=========================================================================*/
// .NAME vtkGlyphKamek - copy oriented and scaled glyph geometry to every input point
// .SECTION Description
// vtkGlyphKamek is a filter that copies a geometric representation (called
...
#ifndef __vtkGlyphKamek_h
#define __vtkGlyphKamek_h
...
class VTK_GRAPHICS_EXPORT vtkGlyphKamek : public vtkPolyDataAlgorithm
{
public:
  vtkTypeMacro(vtkGlyphKamek,vtkPolyDataAlgorithm);
...
private:
  vtkGlyphKamek(const vtkGlyphKamek&);  // Not implemented.
  void operator=(const vtkGlyphKamek&);  // Not implemented.
};

// Description:
// Return the method of scaling as a descriptive character string.
inline const char *vtkGlyphKamek::GetScaleModeAsString(void)
{
...
inline const char *vtkGlyphKamek::GetColorModeAsString(void)
{
...
inline const char *vtkGlyphKamek::GetVectorModeAsString(void)
{
...
inline const char *vtkGlyphKamek::GetIndexModeAsString(void)
{
